...
Bob Rudis (@hrbrmstr) tricked me into creating a scraper for this website.
...
# The scraping
I thought this would be easy and done in a minute. But I'm not really good at scraping it seems.

First I noticed that the website doesn't show you all of the fines. But when we look at the source of the page it seems it should be relatively simple to retrieve the data, the data is
...
![](top10offenders.png)  
  ...
  I also tried it in pure text before I gave up and returned to html parsing.
